...
constexpr uint8_t  MODBUS_FUNC_CODE  = 4;       // FC03 Holding Registers
 ...
 *  Тайминги
 * ================================================================ */
constexpr uint32_t POLL_INTERVAL_SEC     = 60;    // Опрос датчика
constexpr uint32_t SEND_INTERVAL_POLLS   = 60;    // 60×60с = 1 час
